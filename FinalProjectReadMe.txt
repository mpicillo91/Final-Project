...
Note: PHP program is called "inventoryprogramfile1.php".  This PHP program works with "inventoryprogrammongoconnect.sh" and "finaldbbackup.sql".  The code of the PHP program might need to be changed in order to have the PHP program reconginze the correct files.  
